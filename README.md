...
For Cloudflare Workers local deployment, configure `.dev.vars`:
```env
DATABASE_URL="postgres://postgres:[YOUR-PASSWORD]@[YOUR-HOST]:5432/postgres"
BETTER_AUTH_SECRET="your-32-character-random-secret"
BETTER_AUTH_URL="https://zedarchive.your-subdomain.workers.dev"
NEXT_PUBLIC_APP_URL="https://zedarchive.your-subdomain.workers.dev"
```
...
ZedArchive compiles into an optimized Cloudflare Worker bundle using OpenNext:
