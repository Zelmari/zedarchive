      ...
      <main className="za-container py-[var(--za-space-6)]">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          {Array.from({ length: 8 }).map((_, i) => (
            <div
              key={i}
              className="za-bookplate flex animate-pulse flex-row gap-[var(--za-space-3)] overflow-hidden p-[var(--za-space-4)]"
            >
              <div className="h-36 w-28 shrink-0 rounded-small bg-surface-sunken" />
