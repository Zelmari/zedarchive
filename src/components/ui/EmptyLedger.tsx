...
export default function EmptyLedger({ icon, title, description, action }: EmptyLedgerProps) {
  return (
    <div className="za-bookplate relative flex flex-col items-center justify-center px-[var(--za-space-6)] py-[var(--za-space-12)] text-center">
