...
export default function SyncIndicator() {
  ...
  return (
    <button
      ...
      className={`inline-flex cursor-pointer items-center gap-[var(--za-space-1)] rounded-small border px-[var(--za-space-2)] py-0.5 font-[family-name:var(--za-font-mono)] text-[length:var(--za-text-fine)] transition-colors ${statusClass}`}
      title={
        syncState === 'offline'
